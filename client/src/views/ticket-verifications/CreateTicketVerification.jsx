...
function CreateTicketVerification() {
  const navigate = useNavigate()
  const { hosts } = useHosts()
  const { users } = useUsers()
  const { ticketType, createTicketVerification } = useTicketType()


  async function handleSubmit(ticketType) {
    ticketType.preventDefault()
 
    await createTicketVerification(ticketType.data)
  }
...
export default CreateTicketVerification